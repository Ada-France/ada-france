...
package body Adafr.Members.Models is
   ...
   procedure Set_Status (Object : in out Member_Ref;
                         Value  : in Adafr.Members.Models.Status_Type) is
   ...
   begin
      Set_Field (Object, Impl);
      Set_Field_Enum (Impl.all, 15, Impl.Status, Value);
   end Set_Status;

   function Get_Status (Object : in Member_Ref)
                  return Adafr.Members.Models.Status_Type is
      Impl : constant Member_Access
         := Member_Impl (Object.Get_Load_Object.all)'Access;
   begin
      return Impl.Status;
   ...
   begin
      ...
      if Name = "id" then
         ...
         return Adafr.Members.Models.Status_Type_Objects.To_Object (Impl.Status);
   ...
   begin
      ...
      Object.Status := Status_Type'Val (Stmt.Get_Integer (14));
